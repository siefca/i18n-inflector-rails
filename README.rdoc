...
<b>rails-i18n-inflector version <tt>1.0</tt></b> (<b><tt>Sexparty</tt></b>)



* https://rubygems.org/gems/rails-i18n-inflector
* https://github.com/siefca/rails-i18n-inflector/tree
* mailto:pw@gnu.org

== Description

This library contains bindings for the I18n Inflector module for Ruby's I18n.
...
See {whole documentation}[http://rubydoc.info/gems/rails-i18n-inflector/] for more info about the usage.
...
* https://github.com/siefca/rails-i18n-inflector/tree
* <tt>git clone git://github.com/siefca/rails-i18n-inflector.git</tt>
...
* <tt>sudo gem install rails-i18n-inflector</tt>

== Synopsis

  ### Translation data (usually loaded from YAML file):
  ...
  class UsersController << ActiveController
    ...
    # t() will call gender() from the current context
    # to get the inflection token
    # assuming that the method gender gets gender field
    # from the database and converts it to symbol
    def say_welcome
      t('welcome')
      # => "Dear Sir"
    end
...
rails-i18n-inflector is copyrighted software owned by Paweł Wilk (pw@gnu.org).
